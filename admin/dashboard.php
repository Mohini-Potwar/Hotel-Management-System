...
<head>
    ...
    <title>Skyfeather - Admin </title>
    <style>
    /* Apply Times New Roman to headings and specific text sections */
    h1, h2, h3, p, .databox, .chartbox {
        font-family: 'Times New Roman', Times, serif;
    }

    /* If you want to apply it to other elements */
    .box {
        font-family: 'Times New Roman', Times, serif;
    }
</style>
