...
-- Password:   `password`
--
DROP DATABASE IF EXISTS skyfeather;
CREATE DATABASE IF NOT EXISTS skyfeather;

DROP USER IF EXISTS'bluebird_user'@'%';
CREATE USER IF NOT EXISTS 'bluebird_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON skyfeather.* TO 'bluebird_user'@'%';
USE skyfeather;
...
(41, 'Mohini', 'potwarmohini@gmail.com', 'Single Room', 'Single', 1, '2022-11-09', '2022-11-10', 1, 1000.00, 10.00, 'Room only', 0.00, 1010.00);
...
(41, 'Mohini', 'potwarmohini@gmail.com', 'India', '9313346569', 'Single Room', 'Single', 'Room only', '1', '2022-11-09', '2022-11-10', 1, 'Confirm');
...
(1, 'Mohini', 'potwarmohini@gmail.com', '123');
